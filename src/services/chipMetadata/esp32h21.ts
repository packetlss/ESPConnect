// Minimal ESP32-H21 metadata helper (constants mirrored from legacy target for reference)
export const CHIP_NAME = 'ESP32-H21';
export const IMAGE_CHIP_ID = 25;
...
export async function readEsp32H21Metadata(loader: any) {
